...
export function CalendarView({ title, collection, records, definition, onFocus }: { title: string; collection: Collection;
  records: readonly CollectionRecord[]; definition: ViewDefinition; onFocus: (recordId: string) => void }) {
