...
interface Recipe { readonly id: string; readonly trigger: "branch_created" | "pull_request_completed"; readonly targetStatus: { readonly id: string; readonly name: string }; readonly enabled: boolean }
interface Transition { readonly id: string; readonly automationId: string; readonly signalId: string; readonly before: { readonly id: string; readonly name: string }; readonly after: { readonly id: string; readonly name: string }; readonly occurredAt: string; readonly reversedAt?: string }
interface AutomationState { readonly recipes: readonly Recipe[]; readonly transitions: readonly Transition[]; readonly availableStatuses: readonly { readonly id: string; readonly name: string }[] }
