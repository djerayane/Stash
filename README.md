...
The existing operator page and any hand-built HTML or imperative DOM feature surfaces are transitional. A Member-facing ticket is not frontend-complete until its behavior exists in the appropriate React or Expo client and passes client acceptance tests.
